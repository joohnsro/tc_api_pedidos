    ...
    alterarStatusDoPagamento(pedidoId, status) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new pedido_2.PagamentoPorPedido({
                pedidoId, status: pedido_1.StatusPagamento[status]
            });
        });
    }
    criarPagamentoPorPedido(pedidoId, status) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.dataSource.criarPagamentoPorPedido(pedidoId, status)
                .then(() => new pedido_2.PagamentoPorPedido({
                pedidoId, status
            }));
        });
    }
}
exports.default = MongoDBPedidoGateway;
